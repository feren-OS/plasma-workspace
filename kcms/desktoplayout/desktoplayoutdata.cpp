...
DesktopLayoutData::DesktopLayoutData(QObject *parent, const QVariantList &args)
...
DesktopLayoutSettings *DesktopLayoutData::settings() const
{
    return m_settings;
}


#include "desktoplayoutdata.moc"
