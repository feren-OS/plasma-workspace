    ...
    view.delegate: KCM.GridDelegate {
        ...
        thumbnail: Rectangle {
            ...
            Rectangle {
                ...
                color: (model.colorTitlebar && root.accentColor) ? kcm.accentBackground(root.accentColor, model.palette.window) : model.activeTitleBarBackground
                ...
                QtControls.Label {
                    ...
                    color: (model.colorTitlebar && root.accentColor) ? kcm.accentForeground(kcm.accentBackground(root.accentColor, model.palette.window), true) : model.activeTitleBarForeground
